        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinanceCategories_AspNetUsers_UserProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceName = table.Column<string>(type: "TEXT", maxLength: 75, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPasskey", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserPasskey_AspNetUsers_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BudgetItems_FinanceCategories_FinanceCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BudgetItems_FinanceCategoryId",
                table: "BudgetItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinanceCategories_UserProfileId",
                table: "FinanceCategories",
                column: "UserProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPasskey_UserProfileId",
                table: "UserPasskey",
                column: "UserProfileId");
        }
